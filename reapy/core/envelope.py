...
from reapy.core.reapy_object import ReapyObject
from reapy.core.track.automation_item import AutomationItem
...
class Envelope(ReapyObject):
    ...
    @property
    def _args(self) -> ty.Tuple[ty.Union[Track, Take], int]:
